...
contract NPCHome is ERC721Enumerable, ReentrancyGuard, Ownable {

    uint256 public lootersPrice = 10000000000000000; // 0.001 ETH
    ...
    string[] private homeTypes = [
        "Fortress",
        
    ];

    string[] private homeTitles = [
        "of Pattern",
        "of ....",
        "of ...",
    ];
